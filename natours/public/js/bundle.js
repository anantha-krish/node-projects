        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Login was successful!');
              setTimeout(function () {
...
// eslint-disable
var loadMap = function loadMap(locations) {
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/ananthak/cku88tjg534fp18r0og1h74oh',
...
var stripe = Stripe('pk_test_51J7doaSIrf4hhOM7vQasq7NgqmnJnMzcEt630GD5wxlLqwWymBEKwFt5hSqIGX3vWqTarn6r0e5tZkyo6Lre0o5y007HgSofrz');
...
var saveUserForm = document.querySelector('.form-user-data');
...
if (map) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5hbnRoYWsiLCJhIjoiY2t1ODJnaGc5M2RreTJucWh1bmhsY21mZiJ9.uLrrMSTYbrRiKONqJXyJGw';
...
if (saveUserForm) {
  saveUserForm.addEventListener('submit', function (event) {
    event.preventDefault();
    var form = new FormData();
    form.append('email', document.getElementById('email').value);
    form.append('name', document.getElementById('name').value); //handling file

    form.append('photo', document.getElementById('photo').files[0]);
    (0, _login.updateSettings)(form, 'data');
  });
}
